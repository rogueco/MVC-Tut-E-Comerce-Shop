...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        public void CanGetSummaryViewModel()
        {
            ...
            products.Insert(new Product() { Id = "2", Price = 9.99m });
            ...
            Assert.AreEqual(99.98m, basketSummary.BasketTotal);
        }
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            IOrderService orderService = new OrderService(orders);
            IRepository<Customer> customers = new MockContext<Customer>();
            customers.Insert(new Customer() { Id = "1", Email = "test@test.com", PostCode = "90210" });
            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("testy@testa.co.uk", "Forms"), null);
